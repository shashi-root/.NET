...
namespace Db_Pract {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmployeesRow AddEmployeesRow(int EmpNo, string Name, decimal Basic, DepartmentsRow parentDepartmentsRowByFK_Employees_Departments) {
...
namespace Db_Pract.DataSet1TableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Employees] WHERE (([EmpNo] = @Original_EmpNo) AND ([Name] = @O" +
                "riginal_Name) AND ([Basic] = @Original_Basic) AND ([DeptNo] = @Original_DeptNo))" +
                "";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([EmpNo], [Name], [Basic], [DeptNo]) VALUES (@EmpNo" +
                ", @Name, @Basic, @DeptNo);\r\nSELECT EmpNo, Name, Basic, DeptNo FROM Employees WHE" +
                "RE (EmpNo = @EmpNo)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [EmpNo] = @EmpNo, [Name] = @Name, [Basic] = @Basic, [DeptNo] = @DeptNo WHERE (([EmpNo] = @Original_EmpNo) AND ([Name] = @Original_Name) AND ([Basic] = @Original_Basic) AND ([DeptNo] = @Original_DeptNo));
SELECT EmpNo, Name, Basic, DeptNo FROM Employees WHERE (EmpNo = @EmpNo)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Db_Pract.Properties.Settings.Default.RootConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmpNo, Name, Basic, DeptNo FROM dbo.Employees";
        ...
        public virtual int Delete(int Original_EmpNo, string Original_Name, decimal Original_Basic, int Original_DeptNo) {
        ...
        public virtual int Insert(int EmpNo, string Name, decimal Basic, int DeptNo) {
        ...
        public virtual int Update(int EmpNo, string Name, decimal Basic, int DeptNo, int Original_EmpNo, string Original_Name, decimal Original_Basic, int Original_DeptNo) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, decimal Basic, int DeptNo, int Original_EmpNo, string Original_Name, decimal Original_Basic, int Original_DeptNo) {
            return this.Update(Original_EmpNo, Name, Basic, DeptNo, Original_EmpNo, Original_Name, Original_Basic, Original_DeptNo);
        }
    }
